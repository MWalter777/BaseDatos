...
create table EMPLEADO (
   ...
   CODIGO_EMPLEADO      varchar(25)          not null unique,
   ...
   NIT                  char(17)             not null unique,
   ISSS                 char(9)              not null unique,
   NUP                  char(12)             not null unique,
   SALARIO_BASE         decimal(8,2)         not null,
   CORREO_PERSONAL      varchar(60)          not null   unique,
   CORREO_INSTITUCIONAL varchar(60)          not null   unique,
   COMISION             bit         null,
